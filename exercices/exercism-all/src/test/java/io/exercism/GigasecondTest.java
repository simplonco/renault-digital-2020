...
public class GigasecondTest {
    ...
    public void modernTime() {
        LocalDate localDate = LocalDate.of(2011, Month.APRIL, 25);
        Gigasecond gigaSecond = new Gigasecond(localDate);

        LocalDateTime expected = LocalDateTime.of(2043, Month.JANUARY, 1, 1, 46, 40);
        assertEquals(expected, gigaSecond.getDateTime());
    }
